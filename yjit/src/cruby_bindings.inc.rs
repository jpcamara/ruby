...
pub const YARVINSN_trace_objtostring: ruby_vminsn_type = 173;
pub const YARVINSN_trace_opt_ary_freeze: ruby_vminsn_type = 174;
pub const YARVINSN_trace_opt_hash_freeze: ruby_vminsn_type = 175;
pub const YARVINSN_trace_opt_respond_to: ruby_vminsn_type = 176;
...
pub const YARVINSN_zjit_opt_respond_to: ruby_vminsn_type = 236;
